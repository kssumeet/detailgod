...
const stages = [
  {
    ...
    description: "Scratches, swirl marks, oxidation and embedded contaminants degrade the paint and dull reflections.",
    color: "#FFD600",
  ...
  },
  {
    ...
    label: "RESURFACING",
    description: "Multi-stage machine polishing levels the clear coat, removing defects and restoring optical clarity.",
    color: "#00D4FF",
  ...
  },
  {
    ...
    description: "Liquid-deep gloss, hydrophobic protection and a finish engineered to last for years.",
    color: "#FFFFFF",
